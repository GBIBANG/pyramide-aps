...
import gar.org.entites.Dasagrave;
import gar.org.repository.SagraveRepository;

@RestController
@RequestMapping("/pba")
@CrossOrigin(origins = "*")
public class DasagraveController {
	...
	@GetMapping("/dasagraves")
	public Dasagrave getDasagrave() {
		...
		\*------------------------------------------------ */
			...
			Integer vmax = sgr.getMAXDasagrave();
		...
		\*------------------------------------------------ */
			...
			Integer vmin = sgr.getMINDasagrave();
		...
		\*------------------------------------------------ */
			...
			Integer vjanvier = sgr.getSUM(m1);
		...
		\*------------------------------------------------ */
			...
			Integer vfevrier = sgr.getSUM(m2);
	    ...
	    \*------------------------------------------------ */
			...
			Integer vjuillet = sgr.getSUM(m7);
    	...
    	\*------------------------------------------------ */
			...
			Integer vseptembre = sgr.getSUM(m9);
		...
		\*------------------------------------------------ */
			...
			Integer voctobre = sgr.getSUM(m10);
		...
		\*------------------------------------------------ */
			...
			Integer vnovembre = sgr.getSUM(m11);
		...
		\*------------------------------------------------ */
			...
			Integer vdecembre = sgr.getSUM(m12);
		...
		return new Dasagrave(janvier, fevrier, mars, avril, mai, juin, juillet, aout, septembre, octobre, novembre,
