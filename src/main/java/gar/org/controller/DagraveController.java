...
import gar.org.entites.Dagrave;
...
@RequestMapping("/pba")
@CrossOrigin(origins = "*")
public class DagraveController {
	...
	public Dagrave getDagrave() {
    	...
    	\*------------------------------------------------ */
			...
			Integer vseptembre = gr.getSUM(m9);
		...
		\*------------------------------------------------ */
			...
			Integer voctobre = gr.getSUM(m10);
		...
		\*------------------------------------------------ */
			...
			Integer vnovembre = gr.getSUM(m11);
		...
		\*------------------------------------------------ */
			...
			Integer vdecembre = gr.getSUM(m12);
		...
		return new Dagrave(janvier, fevrier, mars, avril, mai, juin,juillet, aout, septembre, octobre, novembre, decembre,
		  somme, sommeb, sommec, sommed, sommee, sommef,total, max, min, nbre, moy);
	}
